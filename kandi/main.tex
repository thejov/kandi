...
\title{Juurisyyanalyysin soveltaminen ohjelmistoprojektien retrospektiiveissä}

% Otsikko tiivistelmään. Jos lisäksi engl. tiivistelmä, niin viimeisin:
\TITLE{Juurisyyanalyysin soveltaminen ohjelmistoprojektien retrospektiiveissä}
...
\KEYWORDS{juurisyyanalyysi, retrospektiivi, ketterä retrospektiivi, agile, RCA, systemaattinen kirjallisuuskatsaus}
