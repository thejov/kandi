...
\large Systemaattinen kirjallisuuskatsaus ja kenttätutkimus}

% Otsikko tiivistelmään. Jos lisäksi engl. tiivistelmä, niin viimeisin:
\TITLE{Juurisyyanalyysin soveltuvuus ohjelmistoprojektien retrospektiiveissä: Systemaattinen kirjallisuuskatsaus ja kenttätutkimus}
